...
public class BajaJugador extends javax.swing.JFrame {
    ...
    public BajaJugador() {
        ...
        for (Map.Entry<Integer, Jugador> entry : AppFutbol.lJugadores.entrySet()) {
            modelo.addElement(entry.getKey()+": "+entry.getValue().nombre); //modelo.addElement(ju.nombre);
        }
        this.jugadoresActivos.setModel(modelo); //Lo añaddimos al jList
    }
    ...
    private void initComponents() {
        ...
        jugadoresActivos = new javax.swing.JList<>();
        ...
        labelSubTitulo.setText("Baja de Jugador");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel1.setText("Lista de jugadores dados de alta:");

        jugadoresActivos.setToolTipText("ID: Nombre");
        jScrollPane1.setViewportView(jugadoresActivos);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BajaJugador().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList<String> jugadoresActivos;
